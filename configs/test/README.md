Download the `test_LR_add.zip` file and extract it to the `data/` directory. You can then use the following command to easily perform tests with scales of 2.5, 3.5, and 5.5.
